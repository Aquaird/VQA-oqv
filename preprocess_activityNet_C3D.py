...
def extract_video_feature(feature_path, json_path, gpu, chunks_size=32):
    ...
    dset = f.create_dataset('c3d', shape=(chunks_size, 20, 4096), maxshape=(None, 20, 4096), chunks=(chunks_size,20,4096), dtype='float32')
    # Session config.
...
def main():
    extract_video_feature('dataset/activityNet/c3d_feature_20.h5', 'dataset/activityNet/qa_anno/activityNet_qa_40.json', '1')
